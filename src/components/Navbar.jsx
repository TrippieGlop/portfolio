  ...
  return (
    <nav className="fixed top-0 w-full bg-black/80 backdrop-blur-md text-white py-4 px-6 flex justify-between items-center z-50">
      ...
      <div className="flex space-x-12">
        <Link to="/" className="hover:text-orange-300 cursor-pointer text-xl">Home</Link>
        <Link to="/projects" className="hover:text-orange-300 cursor-pointer text-xl">Projects</Link>
        <Link to="/experience" className="hover:text-orange-300 cursor-pointer text-xl">Experience</Link>
        <a href="/Marc_Humphrey_Resume_2025.pdf" target="_blank" rel="noopener noreferrer" className="hover:text-orange-300 cursor-pointer text-xl">Resume</a>
      </div>

      <div className="flex space-x-4 items-center">
        <a href="mailto:humphreymn6@gmail.com" className="hover:text-orange-300">
